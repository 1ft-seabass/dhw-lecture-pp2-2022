...
Arduino IDE で新規ファイルを作成し、以下のコードをコピーアンドペーストします。こちらを `dhw-pp2-study-03-06-TempHumid-sensor` というファイル名で保存します。
...
Arduino IDE で新規ファイルを作成し、以下のコードをコピーアンドペーストします。こちらを `dhw-pp2-study-03-07-TempHumid-sensor-LINEBOT` というファイル名で保存します。
